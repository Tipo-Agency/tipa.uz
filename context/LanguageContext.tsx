...
const translations: Record<string, LocalizedString> = {
  ...
  'contact.write_telegram': { ru: 'Написать в Telegram', uz: 'Telegramda yozish', en: 'Write in Telegram' },
  ...
  'lead.write_telegram': { ru: 'Написать в Telegram', uz: 'Telegramda yozish', en: 'Write in Telegram' },
  'quiz.cta': { ru: 'Получить подарок и консультацию', uz: 'Sovg\'a va maslahat olish', en: 'Get your gift and consultation' },
  'quiz.step1_title': { ru: 'Что вас интересует?', uz: 'Nima qiziqtiradi?', en: 'What are you interested in?' },
  'quiz.step2_title': { ru: 'Какая задача сейчас самая больная?', uz: 'Hozir eng og\'riqli vazifa qaysi?', en: 'What\'s your biggest pain point right now?' },
  'quiz.step2_no_leads': { ru: 'Нет стабильных заявок', uz: 'Barqaror arizalar yo\'q', en: 'No stable leads' },
  'quiz.step2_ads': { ru: 'Реклама не окупается', uz: 'Reklama o\'zini oqlamaydi', en: 'Ads don\'t pay off' },
  'quiz.step2_no_system': { ru: 'Нет системы продаж', uz: 'Sotuv tizimi yo\'q', en: 'No sales system' },
  'quiz.step2_scale': { ru: 'Хочу масштабироваться', uz: 'Masshtablashni xohlayman', en: 'Want to scale' },
  'quiz.step3_title': { ru: 'Кто вы?', uz: 'Siz kimsiz?', en: 'Who are you?' },
  'quiz.step3_owner': { ru: 'Владелец бизнеса', uz: 'Biznes egasi', en: 'Business owner' },
  'quiz.step3_marketer': { ru: 'Маркетолог / менеджер', uz: 'Marketer / menejer', en: 'Marketer / manager' },
  'quiz.step3_startup': { ru: 'Стартап / идея', uz: 'Startap / g\'oya', en: 'Startup / idea' },
  'quiz.step3_other': { ru: 'Другое', uz: 'Boshqa', en: 'Other' },
  'quiz.step4_title': { ru: 'Рассматриваете внедрение в ближайшее время?', uz: 'Yaqin orada joriy etishni ko\'rib chiqyapsizmi?', en: 'Considering implementation soon?' },
  'quiz.step4_urgent': { ru: 'Срочно (до 1 месяца)', uz: 'Shoshilinch (1 oygacha)', en: 'Urgent (within 1 month)' },
  'quiz.step4_planning': { ru: 'Планирую (1–3 месяца)', uz: 'Rejalashtiryapman (1–3 oy)', en: 'Planning (1–3 months)' },
  'quiz.step4_exploring': { ru: 'Пока изучаю', uz: 'Hozircha o\'rganyapman', en: 'Just exploring' },
  'quiz.offer_title': { ru: 'Ваш оффер', uz: 'Sizning taklifingiz', en: 'Your offer' },
  'quiz.claim_gift': { ru: 'Забери свой подарок', uz: 'Sovg\'angizni oling', en: 'Claim your gift' },
  'quiz.claim_gift_sub': { ru: 'Оставьте контакты — и мы пришлём подарок и созвонимся', uz: 'Aloqa ma\'lumotlaringizni qoldiring — sovg\'a va qo\'ng\'iroqni yuboramiz', en: 'Leave your contacts and we\'ll send the gift and call you' },
  'quiz.your_gifts': { ru: 'Ваши подарки:', uz: 'Sovg\'alaringiz:', en: 'Your gifts:' },
  'quiz.offer_always_1': { ru: 'Бесплатная консультация', uz: 'Bepul maslahat', en: 'Free consultation' },
  'quiz.offer_always_2': { ru: 'Мини-разбор проекта', uz: 'Loyiha bo\'yicha mini tahlil', en: 'Mini project review' },
  'quiz.offer_smm': { ru: 'Бесплатный тестовый Reels', uz: 'Bepul test Reels', en: 'Free test Reels' },
  'quiz.offer_web': { ru: 'Бесплатный аудит сайта', uz: 'Bepul sayt auditi', en: 'Free site audit' },
  'quiz.offer_ads': { ru: 'Бесплатный аудит рекламы', uz: 'Bepul reklama auditi', en: 'Free ads audit' },
  'quiz.offer_automation': { ru: 'Бесплатная карта процессов', uz: 'Bepul jarayonlar xaritasi', en: 'Free process map' },
  'quiz.final_title': { ru: 'Оставьте контакты', uz: 'Aloqa ma\'lumotlaringizni qoldiring', en: 'Leave your contacts' },
  'quiz.next': { ru: 'Далее', uz: 'Keyingi', en: 'Next' },
  'quiz.back': { ru: 'Назад', uz: 'Orqaga', en: 'Back' },
  'quiz.close': { ru: 'Закрыть', uz: 'Yopish', en: 'Close' },
